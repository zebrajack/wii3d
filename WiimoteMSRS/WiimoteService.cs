...
namespace WiimoteLib
{
    ...
    public class WiimoteService : DsspServiceBase
    {
        ...
        protected override void Start()
        {
			...
			_wm.WiimoteChanged += new WiimoteChangedEventHandler(_wm_WiimoteChanged);
			_wm.WiimoteExtensionChanged += new WiimoteExtensionChangedEventHandler(_wm_WiimoteExtensionChanged);
